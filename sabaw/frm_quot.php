...
$query=mysqli_query($c1,'SELECT * FROM quotation');
...
while ($fetch=mysqli_fetch_assoc($query))
  ...
  echo "<td style='vertical-align: middle;' ><center><p>";
    ...
    echo "<input type=number name='price' value='".$fetch['price']."' min='1' style='width: 8em;' required>";
  echo "</p></center></td>";
  echo "<td style='vertical-align: middle;' ><center><p>";
...
echo '<option value="1" selected>Delivered</option>';
...
$Yourmodal2="Yourmodal2".$fetch['id'];
		echo '<center>';
            ...
            // echo '<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></button></center>';

            echo "<form action='sub_quot.php' method='post'>";
            echo "<input type=hidden name='quot_id' value='".$fetch['id']."'>";
            echo "<input type=hidden name='action' value='price'>";
            echo '<button type="submit" class="btn btn-info" data-toggle="modal"><i class="fa fa-floppy-o fa-1x" aria-hidden="true"></i></button></center>';
