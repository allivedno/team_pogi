...
insert  into `assign`(`assign_id`,`category_id`,`brand_id`) values (2,2,4),(3,3,4),(4,1,4);
...
insert  into `brand`(`brand_id`,`brand_name`,`brand_pic`,`brand_desc`) values (4,'Arnold','imahe/P Arnold.jpeg','KMP'),(6,'KMP','imahe/P KMP4.jpeg','Arnold');
...
insert  into `category`(`category_id`,`category_name`) values (1,'Hydraulic'),(2,'Toxic'),(3,'Yasuo');
...
insert  into `part`(`part_id`,`part_name`,`part_pic`,`assign_id`) values (11,'ARNOLD','imahePART/P ARNOLD11.jpeg',3);
