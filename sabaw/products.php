...
<br><br><br>
<center>
<img class="animated fadeInUp img-fluid" src="img/products/Auma-solution.png">
</center>
...
<div class="col-md-6">
<img class="animated fadeInUp img-fluid" src="img/nproducts/sipos.jpg">
</div>
</div>
...
<div class="col-md-12" style="background-image: url(img/nproducts/fmc.jpg); height: 350px;">
...
<div class="col-md-6" style="background-image: url(img/nproducts/pentair.jpg); height: 400px;">
...
<div>
<div class="row col-md-12">
<div class="col-md-6" style="background-image: url(img/nproducts/merrick2.png);">
<br><br><br><br>
</div>
...
KOSO group has developed a diverse range of high-quality control valves greatly contributing to the implementation of process automation (PA) in various industries. KOSO is able to offer a complete line of automation systems, including sensors, controllers, and computers. Koso is the only valve supplier that does everything - manufacturing of disk stacks including EDM, laser cutting of disks & vacuum brazing of disk stack. Vector™ disks of all available materials are precision manufactured with state of- the-art laser cutting technology. <button type="button" class="btn btn-primary" style="width: 250px;">View Products &nbsp;<i class="fa fa-chevron-right"> </i> </button>
</div>
...
Posiwell is a joint development between : Trisome Technical Services & Supply Ptle Ltd and Valwell Development Enterprise Co; Ltd. Posiwell is designed for low maintenance and in-line repair requiring minimal parts. It is a user friendly product and yet functional without compromising Quality & Performance. Posiwell always provide solutions to meet and (or) exceed Customer’s expectations. <button type="button" class="btn btn-primary" style="width: 250px;">View Products &nbsp;<i class="fa fa-chevron-right"> </i> </button>
</div>
